//+------------------------------------------------------------------+
//|                                                          JMA.mq5 |
//|                                        Copyright 2019, MSK Corp. |
//|                                          https://www.MSKSoft.com |
//+------------------------------------------------------------------+
#property copyright "Copyright 2019, MSK Corp."
#property link      "https://www.MSKSoft.com"
...
//SetLoopCount(0); 
     {
      ...
      int h;
//{--------------------------------------------------------------------} 
   for(shift=rates_total-BarCount-1; shift<rates_total && !IsStopped(); shift++)
     {
      h=rates_total-shift-1;
      series=close[shift];
      //Print(h + "   " + series);
      if(fF0<61)
        {
