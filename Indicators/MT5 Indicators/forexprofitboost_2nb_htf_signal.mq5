//+------------------------------------------------------------------+ 
//|                              ForexProfitBoost_2nb_HTF_Signal.mq5 | 
...
//| Объявление констант                            |
//+------------------------------------------------+
#define INDICATOR_NAME      "ForexProfitBoost_2nb" // Имя индикатора
...
#define UP_SIGNAL_SYMBOL    "ж"                    // Символ для входа в long
#define DN_SIGNAL_SYMBOL    "и"                    // Символ для входа в short
...
input color Upsymbol_Color=clrAqua;                    // Цвет символа роста
...
//--- инициализация переменных начала отсчета данных
   ...
   min_rates_total=int(min_rates_total+1)+int(SignalBar);
...
//--- получение хендла индикатора ForexProfitBoost_2nbSign
   Ind_Handle=iCustom(Symb,Timeframe,"ForexProfitBoost_2nbSign",MAPeriod1,MAType1,MAPrice1,MAPeriod2,MAType2,MAPrice2,0);
   if(Ind_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора ForexProfitBoost_2nbSign");
      return(INIT_FAILED);
     }
//--- инициализации переменной для короткого имени индикатора
   string shortname=IndName;
