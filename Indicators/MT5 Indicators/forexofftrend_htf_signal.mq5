...
//| Объявление констант                            |
//+------------------------------------------------+
#define INDICATOR_NAME      "ForexOFFTrend"     // Имя индикатора
...
//--- получение хендла индикатора ForexOFFTrendSign
   Ind_Handle=iCustom(Symb,Timeframe,"ForexOFFTrendSign",SSP,KPer,Kmax,0);
   if(Ind_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора ForexOFFTrendSign");
      return(INIT_FAILED);
     }
