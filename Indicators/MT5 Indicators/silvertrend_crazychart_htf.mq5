//+------------------------------------------------------------------+ 
//|                                   SilverTrend_CrazyChart_HTF.mq5 | 
//|                               Copyright © 2014, Nikolay Kositsin | 
//|                              Khabarovsk,   farria@mail.redcom.ru | 
//+------------------------------------------------------------------+ 
#property copyright "Copyright © 201SilverTrend_CrazyChart_HTF, Nikolay Kositsin"
#property link "arria@mail.redcom.ru"
//--- номер версии индикатора
#property version   "1.60"
#property description "SilverTrend_CrazyChart с возможностью изменения таймфрейма во входных параметрах"
...
#define INDICATOR_NAME "SilverTrend_CrazyChart"  // Константа для имени индикатора
...
#property indicator_label1  "SilverTrend_CrazyChart HTF"
//+----------------------------------------------+
...
//--- инициализация переменных 
   min_rates_total=2;
//--- получение хендла индикатора SilverTrend_CrazyChart
   Ind_Handle=iCustom(Symbol(),TimeFrame,"SilverTrend_CrazyChart",SSP,Kmin,Kmax);
   if(Ind_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора SilverTrend_CrazyChart");
      return(INIT_FAILED);
     }
