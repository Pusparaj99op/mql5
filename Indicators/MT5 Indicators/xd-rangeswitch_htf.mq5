...
#property description "The XD-RangeSwitch indicator with timeframe selection option available in input parameters"
...
#define INDICATOR_NAME " XD-RangeSwitch"    // A constant for the indicator name
...
input uint N=4;                             // Number of peaks
...
//--- initialization of variables 
   min_rates_total=2;
//--- getting the handle of the XD-RangeSwitch indicator
   Ind_Handle=iCustom(Symbol(),TimeFrame,"XD-RangeSwitch",N,0);
   if(Ind_Handle==INVALID_HANDLE)
     {
      Print(" Failed to get the handle of the XD-RangeSwitch indicator");
      return(INIT_FAILED);
     }
